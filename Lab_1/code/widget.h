...
public slots:
    ...
    void slidersMoved(int arg);
    void spinsChanged(int arg);
    void colorSelection();

    double RGB_To_XYZ(double arg);
    double XYZ_To_LAB(double arg);

    double XYZ_To_RGB(double arg);
    double LAB_To_XYZ(double arg);
...
private:
    Ui::Widget* ui;
    QColor* color_converter;//color sample is stored here
    space_name space_id;    //color systems identifiers
    ...
    QLabel* ColorRect;      //color sample viewer

    QString r;
    QString g;
    QString b;

    //sliders for choosing the color (4 for CMYK)
    QSlider* Slider1;
    QSlider* Slider2;
    QSlider* Slider3;
    QSlider* Slider4;

    //labels for identifying the sliders
    QLabel* SliderLabel1;
    QLabel* SliderLabel2;
    QLabel* SliderLabel3;
    QLabel* SliderLabel4;

    //color system choosing interface
    QComboBox* LeftCB;
    QComboBox* CentralCB;
    QComboBox* RightCB;

    //layouts for organising GUI elements
    QGridLayout* backgr;
    QGridLayout* sliders;

    //Spinboxes for color input (in 3 systems, 4 labels for CMYK)
    QSpinBox* Left1;
    QSpinBox* Left2;
    QSpinBox* Left3;
    QSpinBox* Left4;
    ...
    //labels for identifying spinboxes
    QLabel* LLabel1;
    QLabel* LLabel2;
    QLabel* LLabel3;
    QLabel* LLabel4;
